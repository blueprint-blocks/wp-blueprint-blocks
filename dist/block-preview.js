(function (require$$0$1, require$$0, blocks, blockEditor) {
  'use strict';
  ...
  document.querySelectorAll(".blueprint-blocks-block-preview").forEach(function ($el) {
    var _$el$dataset;
    var blockType = blocks.getBlockType((_$el$dataset = $el.dataset) === null || _$el$dataset === void 0 ? void 0 : _$el$dataset.blockName);
    if (!blockType) {
      return null;
    }
...
})(React, ReactDOM, wp.blocks, wp.blockEditor);
