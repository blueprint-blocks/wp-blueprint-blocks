...
if ( $current_screen->base === 'toplevel_page_blueprint-blocks-start' ) {
	$current_page = 'getting-started';
} elseif ( $current_screen->base === 'blocks_page_blueprint-blocks-settings' ) {
...
<div class="blueprint-blocks-nav-menu">
	...
	<ul class="blueprint-blocks-nav-menu--nav">
		<li<?php if ( $current_page === 'getting-started' ): ?> class="is-active"<?php endif; ?>>
			<a href="<?php echo admin_url( 'admin.php?page=blueprint-blocks-start' ); ?>"><?php _e( 'Getting Started', blueprint_blocks()::TEXT_DOMAIN ); ?></a>
		</li>
		...
		<li<?php if ( $current_page === 'settings' ): ?> class="is-active"<?php endif; ?>>
			<a href="<?php echo admin_url( 'admin.php?page=blueprint-blocks-settings' ); ?>"><?php _e( 'Settings', blueprint_blocks()::TEXT_DOMAIN ); ?></a>
		</li>
	</ul>
</div>
