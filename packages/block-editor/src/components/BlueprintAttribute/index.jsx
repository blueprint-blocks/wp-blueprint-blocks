...
const BlueprintAttribute = memo(
	({ attributeName = null, editorRef = null }) => {
		...
		const allowsNullDefault = useMemo(
			() =>
				(attributeTypes?.[attribute.type]?.allowsNull === false &&
					false) ||
				true,
			[attribute],
		);
		...
		return (
			<div ref={ref} className="BlueprintAttribute">
				...
				<div className="BlueprintAttribute-line">
					<span
						className={clsx({ "is-invalid": !attributeNameValid })}
					>
				...
				<div className="BlueprintAttribute-line indent">
					<span
						className={clsx({ "is-invalid": !attributeTypeValid })}
					>
