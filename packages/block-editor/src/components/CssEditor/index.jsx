			...
			<CodeMirror
				...
				extensions={ [
					...
					EditorView.updateListener.of( ( view ) => {
						const currentSelectionRange = view.state.selection.asSingle().ranges[ 0 ]
						if ( currentSelectionRange.from !== selectionRange.from || currentSelectionRange.to !== selectionRange.to ) {
