...
import { getBlockComponent, setComponentAttribute } from '../../store/block-blueprint'
...
const BlueprintSidebarContextPanel = forwardRef( ( {
	editorRef = null,
}, ref ) => {
	...
	return (
		<div ref={ ref } className="BlueprintSidebarContextPanel">

			{ context === 'component' && property === 'attributeName' && (
			...
			{ context === 'component' && property === 'attributeValue' && (
				<BlueprintContextualAttributeValueHelp
					componentType={ type }
					attributeName={ currentFocus?.attributeName }
					attributeValue={ currentFocus?.attributeValue }
				/>
			) }
