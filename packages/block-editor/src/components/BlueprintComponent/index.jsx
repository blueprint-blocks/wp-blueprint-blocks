...
import { getBlockComponent, startDraggingExistingComponent, stopDragging, unsetDraggingComponent } from '../../store/block-blueprint'
...
function BlueprintComponent( {
	...
	return (
		<div
			ref={ ref }
			className={ classNames( 'BlueprintComponent', { 'is-draggable': draggable } ) }
			style={ { '--indent': indent } }
		>
